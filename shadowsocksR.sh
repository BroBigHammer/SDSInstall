...
echo "# Author: KaneZhang                                         #"
echo "# Github: https://github.com/kanecolin/SDSInstall           #"
echo "#############################################################"
echo
...
pre_install(){
    ...
    read -p "(Default password: kanezhang.com):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="kanezhang.com"
    echo
    echo "---------------------------"
